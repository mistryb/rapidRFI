...
/**
 * This is the model class for table "tbl_response_file".
 *
 * The followings are the available columns in table 'tbl_response_file':
 * @property integer $id
...
class ResponseFile extends CActiveRecord
{
	 ...
	 * @return ResponseFile the static model class
	 */
